# Module2-13hw https://elya88.github.io/Module2-13hw/

Типы HTTP-запросов и философия REST Разработка веб-сайтов * Этот пост — ответ на вопрос, заданный в комментарии к одной из моих статей.
